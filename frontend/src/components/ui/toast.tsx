  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        destructive: "border-destructive/20 bg-[#fff1f1] text-[#a2191f]",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "bg-transparent px-3 text-sm tracking-[0.16px] transition-colors",
      "hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-0",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn("text-sm font-normal tracking-[0.16px]", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("text-sm opacity-80 tracking-[0.16px]", className)} {...props} />
))
