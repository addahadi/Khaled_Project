...
export default function Profile() {
 ...
 <div className="flex h-8 w-8 items-center justify-center  bg-muted mt-0.5">
 ...
 <h1 className="text-[28px] font-light">My Profile</h1>
 ...
 <AvatarFallback className="text-xl font-normal bg-primary text-primary-foreground">
 {initials}
 </AvatarFallback>
 </Avatar>
 <div>
