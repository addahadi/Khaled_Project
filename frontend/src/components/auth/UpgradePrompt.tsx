...
const COPY = {
  prediction: {
    ...
    badge:       'Trial Limit',
    bullet1:     'Unlimited predictions on Hospital plan',
    bullet2:     '500 predictions / month on Clinic plan',
  ...
  user: {
    ...
    badge:       'Trial Limit',
    bullet1:     'Unlimited staff on Hospital plan',
    bullet2:     'Up to 20 staff on Clinic plan',
