...
export default function NewPrediction() {
 ...
 {selectedPatient && (
 <div className=" bg-muted/40 p-3 space-y-1 text-sm">
 ...
 <span className="font-normal">{Math.round(result.risk_score * 100)}%</span>
 </div>
 ...
 {/* Overage notice */}
 {overageWarn && (
 <div className=" bg-[#fff2e8] dark:bg-orange-950/20 p-3 text-sm text-[#ff832b] dark:text-orange-300 flex gap-2">
