...
export default function Alerts() {
 ...
 switch (type) {
 case 'CRITICAL': return <AlertTriangle className="h-5 w-5 text-[#da1e28]" />;
 case 'HIGH': return <TrendingUp className="h-5 w-5 text-[#ff832b]" />;
 ...
 <div>
 <h1 className="text-[28px] font-light flex items-center gap-2">
 ...
 <CheckCircle2 className="mx-auto h-12 w-12 text-[#24a148]/50 mb-3" />
 ...
 <Card key={alert.alert_id} className={`transition-all ${alert.is_read ? 'opacity-70 bg-muted/20' : 'border-l-4 border-l-primary '}`}>
