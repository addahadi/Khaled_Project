...
export default function LabDashboard() {
 ...
 INPROGRESS: 'bg-primary text-primary border-blue-200',
 ...
 <div>
 <h1 className="text-[28px] font-light">Lab Dashboard</h1>
 ...
 {[
 { label: 'Pending Orders',  val: stats?.pending_count,  icon: Clock,  color: 'text-[#a2680a]' },
 { label: 'In Progress',  val: stats?.inprogress_count, icon: FlaskConical,  color: 'text-primary' },
 { label: 'Completed Today',  val: stats?.completed_today,  icon: CheckCircle2,  color: 'text-[#24a148]' },
 ...
 : <div className="text-[28px] font-light">{val ?? '—'}</div>
 }
 </CardContent>
 </Card>
 ))}
 ...
 <CheckCircle2 className="mx-auto h-8 w-8 mb-2 text-[#24a148]" />
