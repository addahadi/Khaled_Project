                ...
                <div className="col-span-6 sm:col-span-2 space-y-1">
                  <Label className="text-xs">
                    ...
                    {hasRefRange && !isCompleted && (
                      <span className="text-xs font-normal text-blue-600">(auto)</span>
                    )}
                  </Label>
                  {hasRefRange && !isCompleted ? (
                    <div className="h-9 flex items-center px-3 rounded-md border bg-blue-50 text-xs text-blue-700 font-medium">
                      Server-computed
                    </div>
                  ) : (
                    <Select
